...
NOMV:
		...
		JMP	MCINPUT		; process move
DONE:
		JMP $FE00		; *** MUST set this to YOUR OS STArting address
;		
...
RETP:
		LDA	#$2E		; print ... instead of flashing disp
...
;Init_6551:
;        lda   #$1F               ; 19.2K/8/1
;        STA   ACIA_CTRL            ; control reg 
;        lda   #$0B               ; N parity/echo off/rx int off/ dtr active low
;        STA   ACIA_CMD            ; commAND reg 
;        rts                      ; done
;
